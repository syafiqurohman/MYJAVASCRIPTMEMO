...
// Change direction on each click
...
const initGame = () => {
  ...
  if (snakeX === foodX && snakeY === foodY) {
    ...
    score++;
    highScore = score >= highScore ? score : highScore; // jika score > high score => high score = score
  ...
  //shifting forqward values of elemnets in snake body by one
